...
#define BOARD_NAME                  "Compotes Driver Board"
...
#define JUMPER_1_GPIO GPIOA
#define JUMPER_2_GPIO GPIOA
...
#define GREEN_LED                   4U
#define ANALOG_IN                   5U
#define MOTOR_IN_1                  6U
#define MOTOR_IN_2                  7U
#define GPIOA_PIN8                  8U
#define ENCODER_A                   9U
#define ENCODER_B                   10U
 ...
 * GPIOA setup:
 *
 * PA0  - JUMPER_1                  (input pullup).
 * PA1  - JUMPER_2                  (input pullup).
 * PA2  - USART_TX                  (alternate 1).
 * PA3  - USART_RX                  (alternate 1).
 * PA4  - GREEN_LED                 (output pushpull high).
 * PA5  - ANALOG_IN                 (analog).
 * PA6  - MOTOR_IN_1                (alternate 1).
 * PA7  - MOTOR_IN_2                (alternate 1).
 * PA8  - PIN8                      (input pullup).
 * PA9  - ENCODER_1                 (alternate 2).
 * PA10 - ENCODER_2                 (alternate 2).
 ...
 */
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(JUMPER_1) |             \
                                     PIN_MODE_INPUT(JUMPER_2) |             \
                                     PIN_MODE_ALTERNATE(USART_TX) |         \
                                     PIN_MODE_ALTERNATE(USART_RX) |         \
                                     PIN_MODE_OUTPUT(GREEN_LED) |           \
                                     PIN_MODE_ANALOG(ANALOG_IN) |           \
                                     PIN_MODE_OUTPUT(MOTOR_IN_1) |          \
                                     PIN_MODE_OUTPUT(MOTOR_IN_2) |          \
                                     PIN_MODE_INPUT(GPIOA_PIN8) |           \
                                     PIN_MODE_ALTERNATE(ENCODER_A) |        \
                                     PIN_MODE_ALTERNATE(ENCODER_B) |        \
                                     PIN_MODE_INPUT(GPIOA_PIN11) |          \
                                     PIN_MODE_INPUT(GPIOA_PIN12) |          \
                                     PIN_MODE_ALTERNATE(SWDIO) |            \
                                     PIN_MODE_ALTERNATE(SWCLK) |            \
                                     PIN_MODE_INPUT(GPIOA_PIN15))
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(JUMPER_1) |         \
                                     PIN_OTYPE_PUSHPULL(JUMPER_2) |         \
                                     PIN_OTYPE_PUSHPULL(USART_TX) |         \
                                     PIN_OTYPE_PUSHPULL(USART_RX) |         \
                                     PIN_OTYPE_PUSHPULL(GREEN_LED) |        \
                                     PIN_OTYPE_PUSHPULL(ANALOG_IN) |        \
                                     PIN_OTYPE_PUSHPULL(MOTOR_IN_1) |       \
                                     PIN_OTYPE_PUSHPULL(MOTOR_IN_2) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN8) |       \
                                     PIN_OTYPE_PUSHPULL(ENCODER_A) |        \
                                     PIN_OTYPE_PUSHPULL(ENCODER_B) |        \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN11) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN12) |      \
                                     PIN_OTYPE_PUSHPULL(SWDIO) |            \
                                     PIN_OTYPE_PUSHPULL(SWCLK) |            \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN15))
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_40M(JUMPER_1) |             \
                                     PIN_OSPEED_40M(JUMPER_2) |             \
                                     PIN_OSPEED_40M(USART_TX) |             \
                                     PIN_OSPEED_40M(USART_RX) |             \
                                     PIN_OSPEED_40M(GREEN_LED) |            \
                                     PIN_OSPEED_40M(ANALOG_IN) |            \
                                     PIN_OSPEED_40M(MOTOR_IN_1) |           \
                                     PIN_OSPEED_40M(MOTOR_IN_2) |           \
                                     PIN_OSPEED_40M(GPIOA_PIN8) |           \
                                     PIN_OSPEED_40M(ENCODER_A) |            \
                                     PIN_OSPEED_40M(ENCODER_B) |            \
                                     PIN_OSPEED_40M(GPIOA_PIN11) |          \
                                     PIN_OSPEED_40M(GPIOA_PIN12) |          \
                                     PIN_OSPEED_40M(SWDIO) |                \
                                     PIN_OSPEED_40M(SWCLK) |                \
                                     PIN_OSPEED_40M(GPIOA_PIN15))
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_PULLUP(JUMPER_1) |           \
                                     PIN_PUPDR_PULLUP(JUMPER_2) |           \
                                     PIN_PUPDR_FLOATING(USART_TX) |         \
                                     PIN_PUPDR_FLOATING(USART_RX) |         \
                                     PIN_PUPDR_FLOATING(GREEN_LED) |        \
                                     PIN_PUPDR_FLOATING(ANALOG_IN) |        \
                                     PIN_PUPDR_FLOATING(MOTOR_IN_1) |       \
                                     PIN_PUPDR_FLOATING(MOTOR_IN_2) |       \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN8) |         \
                                     PIN_PUPDR_FLOATING(ENCODER_A) |        \
                                     PIN_PUPDR_FLOATING(ENCODER_B) |        \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN11) |        \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN12) |        \
                                     PIN_PUPDR_PULLUP(SWDIO) |              \
                                     PIN_PUPDR_PULLDOWN(SWCLK) |            \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN15))
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(JUMPER_1) |               \
                                     PIN_ODR_HIGH(JUMPER_2) |               \
                                     PIN_ODR_HIGH(USART_TX) |               \
                                     PIN_ODR_HIGH(USART_RX) |               \
                                     PIN_ODR_HIGH(GREEN_LED) |              \
                                     PIN_ODR_HIGH(ANALOG_IN) |              \
                                     PIN_ODR_HIGH(MOTOR_IN_1) |             \
                                     PIN_ODR_HIGH(MOTOR_IN_2) |             \
                                     PIN_ODR_HIGH(GPIOA_PIN8) |             \
                                     PIN_ODR_HIGH(ENCODER_A) |              \
                                     PIN_ODR_HIGH(ENCODER_B) |              \
                                     PIN_ODR_HIGH(GPIOA_PIN11) |            \
                                     PIN_ODR_HIGH(GPIOA_PIN12) |            \
                                     PIN_ODR_HIGH(SWDIO) |                  \
                                     PIN_ODR_HIGH(SWCLK) |                  \
                                     PIN_ODR_HIGH(GPIOA_PIN15))
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(JUMPER_1, 0) |             \
                                     PIN_AFIO_AF(JUMPER_2, 0) |             \
                                     PIN_AFIO_AF(USART_TX, 1) |             \
                                     PIN_AFIO_AF(USART_RX, 1) |             \
                                     PIN_AFIO_AF(GREEN_LED, 0) |            \
                                     PIN_AFIO_AF(ANALOG_IN, 2) |            \
                                     PIN_AFIO_AF(MOTOR_IN_1, 0) |           \
                                     PIN_AFIO_AF(MOTOR_IN_2, 0))
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_PIN8, 0) |           \
                                     PIN_AFIO_AF(ENCODER_A, 2) |            \
                                     PIN_AFIO_AF(ENCODER_B, 2) |            \
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_PIN0) |       \
                                     PIN_OTYPE_PUSHPULL(MOTOR_ENABLE) |     \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLUP(GPIOB_PIN0) |         \
                                     PIN_PUPDR_FLOATING(MOTOR_ENABLE) |     \
